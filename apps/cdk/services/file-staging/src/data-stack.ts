...
export interface FileStagingServiceDataStackProps extends StackProps {
	readonly backboneStack: BackboneStack;
}

export class FileStagingServiceDataStack extends Stack {
	readonly table: TableV2;

	constructor(
		scope: Construct,
		id: string,
		props: FileStagingServiceDataStackProps,
	) {
